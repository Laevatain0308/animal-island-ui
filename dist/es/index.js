...
import B, { useState as P, useCallback as F, useMemo as nt, useRef as $, useEffect as L } from "react";
import { createPortal as it } from "react-dom";
import st from "../files/icon-leaf.40329f03.png";
const ot = "animal-btn-QoKe1", lt = "animal-btn-small-6Srsd", ct = "animal-btn-middle-zEXqv", ut = "animal-btn-large-k9IvA", ht = "animal-btn-default-L7yE6", dt = "animal-btn-primary-9tMG9", pt = "animal-btn-dashed-wzZ-i", ft = "animal-btn-text-Tope4", mt = "animal-btn-link-pURnf", gt = "animal-btn-danger-zQ4kF", _t = "animal-btn-ghost-Ykty4", yt = "animal-btn-block-MC4pp", vt = "animal-btn-loading-PfXLM", bt = "animal-animal-btn-loading-Rf1hg", wt = "animal-btn-icon-P5CS9", A = {
  btn: ot,
  ...
  return /* @__PURE__ */ g(
    "button",
    {
      ...
      ...b,
      children: [
        l && !e && /* @__PURE__ */ n("span", { className: A["btn-icon"], children: l }),
        v && /* @__PURE__ */ n("span", { children: v })
      ]
    }
  );
};
Y.displayName = "Button";
const xt = "animal-wrapper-IRrhj", Ct = "animal-wrapper-disabled-MWwHK", Tt = "animal-input-12WUn", kt = "animal-wrapper-no-shadow-WP9Gk", Pt = "animal-wrapper-small-mWvja", Mt = "animal-wrapper-middle-zXqMR", Lt = "animal-wrapper-large-RrYM4", St = "animal-wrapper-error-W-VRo", Rt = "animal-wrapper-warning-miO7A", Ot = "animal-prefix-g8f1R", Dt = "animal-suffix-o7ywP", At = "animal-clear-HuR2N", O = {
  wrapper: xt,
  ...
  const [y, d] = P(v ?? ""), _ = c !== void 0, p = _ ? c : y, u = F(
    (f) => {
      _ || d(f.target.value), h?.(f);
    },
    [_, h]
  ), w = F(() => {
    _ || d(""), b?.();
    const f = new Event("input", { bubbles: !0 }), I = { value: "" };
    h?.({
      target: I,
      currentTarget: I,
      nativeEvent: f
    ...
    O[`wrapper-${t}`],
    o && O[`wrapper-${o}`],
    s && O["wrapper-disabled"],
    !e && O["wrapper-no-shadow"],
    l
  ].filter(Boolean).join(" ");
  return /* @__PURE__ */ g("span", { className: T, children: [
    r && /* @__PURE__ */ n("span", { className: O.prefix, children: r }),
    /* @__PURE__ */ n(
      "input",
      {
        className: O.input,
    ...
    a && /* @__PURE__ */ n("span", { className: O.suffix, children: a })
  ] });
};
Nt.displayName = "Input";
const Bt = "animal-switch-disabled-U5tjL", zt = "animal-switch-checked-6HKL4", It = "animal-switch-small-jkWtD", Et = "animal-handle-KgZ7M", Ft = "animal-inner-5x97M", $t = "animal-switch-loading--3JYL", Gt = "animal-spinner-QK4sP", jt = "animal-animal-spin-P6YYa", N = {
  ...
  const [v, h] = P(r), b = t !== void 0, m = b ? t : v, y = F(() => {
    if (i || o) return;
    const _ = !m;
    b || h(_), l?.(_);
  }, [i, o, m, b, l]), d = [
  ...
  return /* @__PURE__ */ g(
    "button",
    {
      ...
      disabled: i,
      children: [
        /* @__PURE__ */ n("span", { className: N.handle, children: o && /* @__PURE__ */ n("span", { className: N.spinner }) }),
        /* @__PURE__ */ n("span", { className: N.inner, children: m ? e : s })
      ]
    }
  );
};
qt.displayName = "Switch";
const Q = ({ children: t, className: r, style: a }) => /* @__PURE__ */ n(
  "div",
  {
    className: `animal-cursor${r ? ` ${r}` : ""}`,
    style: a,
    children: t
  }
);
Q.displayName = "Cursor";
const W = (t) => t == null || typeof t == "boolean" ? 0 : typeof t == "string" || typeof t == "number" ? String(t).length : Array.isArray(t) ? t.reduce((r, a) => r + W(a), 0) : B.isValidElement(t) ? W(t.props.children) : 0, U = (t, r, a = "tw") => {
  if (r.stopped || t == null || typeof t == "boolean") return null;
  if (typeof t == "string" || typeof t == "number") {
    const i = String(t);
    if (r.remaining >= i.length)
      return r.remaining -= i.length, i;
    const o = i.slice(0, r.remaining);
    return r.remaining = 0, r.stopped = !0, o;
  }
  if (Array.isArray(t))
    return t.map((i, o) => /* @__PURE__ */ n(B.Fragment, { children: U(i, r, `${a}-${o}`) }, `${a}-${o}`));
  if (B.isValidElement(t)) {
    const i = t.props, o = U(i.children, r, a);
    return B.cloneElement(t, void 0, o);
  }
  return null;
}, rt = ({
  children: t,
  ...
  const e = nt(() => W(t), [t]), [s, l] = P(i ? 0 : e), c = $(null);
  return L(() => {
    ...
    if (l(0), e !== 0)
      return c.current = window.setInterval(() => {
        l((h) => h >= e ? (c.current && window.clearInterval(c.current), h) : h + 1);
      }, r), () => {
        c.current && window.clearInterval(c.current);
      };
  }, [e, r, a, i]), L(() => {
    e > 0 && s >= e && o?.();
  }, [s, e]), /* @__PURE__ */ n(Z, { children: U(t, { remaining: s, stopped: !1 }) });
};
rt.displayName = "Typewriter";
const Ht = "animal-mask-hAWeP", Yt = "animal-modal-d0zyM", Wt = "animal-modalClipped-7IuAw", Ut = "animal-header-udOSi", Vt = "animal-title-s6pv3", Xt = "animal-body--aiyx", Zt = "animal-footer-9Ib-a", z = {
  mask: Ht,
  modal: Yt,
  modalClipped: Wt,
  header: Ut,
  ...
  }, [t, e]), L(() => (t && (document.body.style.overflow = "hidden"), () => {
  ...
  if (!t) return null;
  const _ = /* @__PURE__ */ g(Z, { children: [
    /* @__PURE__ */ n(Y, { type: "primary", onClick: e, children: "取消" }),
    /* @__PURE__ */ n(Y, { type: "primary", onClick: s, children: "确定" })
  ] }), p = /* @__PURE__ */ n(Q, { children: /* @__PURE__ */ n("div", { className: z.mask, onClick: y, children: /* @__PURE__ */ g(
    "div",
    {
      className: [z.modal, c].filter(Boolean).join(" "),
      style: { width: a },
      onClick: d,
      role: "dialog",
      "aria-modal": "true",
      children: [
        /* @__PURE__ */ n(Qt, {}),
        /* @__PURE__ */ g("div", { className: z.modalClipped, children: [
          r && /* @__PURE__ */ n("div", { className: z.header, children: r && /* @__PURE__ */ n("div", { className: z.title, children: r }) }),
          /* @__PURE__ */ n("div", { className: z.body, children: h ? /* @__PURE__ */ n(rt, { speed: v, trigger: b, children: l }) : l }),
          o !== null && /* @__PURE__ */ n("div", { className: z.footer, children: o === void 0 ? _ : o })
        ] })
      ]
    }
  ) }) });
  return it(p, document.body);
};
Jt.displayName = "Modal";
const Kt = "animal-card-DJ515", te = "animal-card-title-PL-WB", ee = "animal-card-dashed-fqnm1", ne = "animal-card-app-pink-3Eo8d", re = "animal-card-purple-Gq7sR", ae = "animal-card-app-blue-GHH1a", ie = "animal-card-app-yellow-DWB-L", se = "animal-card-app-orange-V5yD7", oe = "animal-card-app-teal-R5kFG", le = "animal-card-app-green-xlNUs", ce = "animal-card-app-red-DzE0l", ue = "animal-card-lime-green-KiJbe", he = "animal-card-yellow-green-4c-lF", de = "animal-card-brown-hLCrx", pe = "animal-card-warm-peach-pink-RlSVo", G = {
  card: Kt,
  ...
  const s = [
    G.card,
    t === "title" && G["card-title"],
    t === "dashed" && G["card-dashed"],
    r !== "default" && G[`card-${r}`],
    i
  ].filter(Boolean).join(" ");
  return /* @__PURE__ */ n(
...
fe.displayName = "Card";
const me = "animal-footer-5DMOR", ge = "animal-tree-KZ8hX", J = {
  footer: me,
  tree: ge
}, _e = ({
  type: t = "tree",
  ...
  const i = [J.footer, J[t], r].filter(Boolean).join(" ");
  return /* @__PURE__ */ n("div", { className: i, style: a });
};
_e.displayName = "Footer";
const ye = "animal-faqCard-5jlOE", ve = "animal-disabled-9DAjm", be = "animal-questionHeader-iqP87", we = "animal-questionIcon-xRkdp", xe = "animal-expanded-a8Eze", Ce = "animal-questionText-jVpUv", Te = "animal-leafDecoration-RoK4H", ke = "animal-answerWrapper-tzFtx", Pe = "animal-answerContent-ppsk-", D = {
  faqCard: ye,
  disabled: ve,
  questionHeader: be,
  questionIcon: we,
  ...
  return /* @__PURE__ */ g("div", { className: v, style: e, children: [
    /* @__PURE__ */ g(
      "button",
      {
        className: D.questionHeader,
        onClick: c,
        disabled: i,
        "aria-expanded": s,
        children: [
          /* @__PURE__ */ n("span", { className: D.questionIcon, children: s ? "−" : "+" }),
          /* @__PURE__ */ n("span", { className: D.questionText, children: t }),
          /* @__PURE__ */ n("span", { className: D.leafDecoration, children: /* @__PURE__ */ n("svg", { viewBox: "0 0 24 24", width: "20", height: "20", children: /* @__PURE__ */ n(
            "path",
            {
              fill: "currentColor",
    ...
    /* @__PURE__ */ n("div", { className: D.answerWrapper, children: /* @__PURE__ */ n("div", { className: D.answerContent, children: r }) })
  ] });
};
Me.displayName = "Collapse";
const Le = "animal-acDatetime-hVKh7", Se = "animal-acDate-rhO3k", Re = "animal-acWeekday-bxDHR", Oe = "animal-acMonthday-1jUmX", De = "animal-acTime-S-twb", Ae = "animal-acColon-g4vuJ", E = {
  acDatetime: Le,
  acDate: Se,
  acWeekday: Re,
  acMonthday: Oe,
  acTime: De,
  acColon: Ae
}, Ne = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], Be = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], ze = ({ className: t }) => {
  const [r, a] = P(/* @__PURE__ */ new Date());
  return L(() => {
    const i = setInterval(() => a(/* @__PURE__ */ new Date()), 1e3);
    return () => clearInterval(i);
  }, []), /* @__PURE__ */ n(Q, { children: /* @__PURE__ */ g("div", { className: `${E.acDatetime} ${t || ""}`, children: [
    /* @__PURE__ */ g("div", { className: E.acDate, children: [
      /* @__PURE__ */ n("span", { className: E.acWeekday, children: Ne[r.getDay()] }),
      /* @__PURE__ */ g("span", { className: E.acMonthday, children: [
        Be[r.getMonth()],
        " ",
        r.getDate()
      ] })
    ] }),
    /* @__PURE__ */ g("div", { className: E.acTime, children: [
      r.getHours().toString().padStart(2, "0"),
      /* @__PURE__ */ n("span", { className: E.acColon, children: ":" }),
      r.getMinutes().toString().padStart(2, "0")
    ] })
  ] }) });
};
ze.displayName = "Time";
const Ie = "animal-phoneContainer-49yKw", Ee = "animal-phone-bXgSa", Fe = "animal-statusBar-Vb96q", $e = "animal-time-cokU-", Ge = "animal-signalIcons-TuL3l", je = "animal-screenContent-oyJF-", qe = "animal-homeScreen-no2yS", He = "animal-grasswave-l6cyA", Ye = "animal-dateDisplay-cnvu8", We = "animal-dateDisplayHeader-32i0J", Ue = "animal-blink--R0wf", Ve = "animal-dayText-7NEMb", Xe = "animal-appsGrid-opTs8", Ze = "animal-appItem-1NmDt", Qe = "animal-appIcon-tTPIg", Je = "animal-iconBounce-n4Boc", Ke = "animal-appIconOffset-b5SZG", tn = "animal-iconBounceOffset-XfsXI", en = "animal-appItemOffset-FEStg", nn = "animal-iconCamera-c-grH", rn = "animal-iconMiles-L9Cow", an = "animal-iconCritterpedia-okU95", sn = "animal-iconDiy-gZgxn", on = "animal-iconDesign-YvE9z", ln = "animal-iconMap-xmfHe", cn = "animal-iconVariant-k-kkB", un = "animal-iconHelicopter-HV-TH", hn = "animal-iconChat-TVZXY", dn = "animal-iconWifi-RoLJH", pn = "animal-iconLocation-YfhoK", fn = "animal-iconPage-wMmBC", mn = "animal-badge-drGmk", gn = "animal-pageIndicator-mQ-Pg", C = {
  phoneContainer: Ie,
  phone: Ee,
  statusBar: Fe,
  time: $e,
  ...
  const i = r.getHours(), o = r.getMinutes(), e = i >= 12 ? "PM" : "AM", s = i % 12 || 12, l = o.toString().padStart(2, "0");
  return /* @__PURE__ */ n("div", { className: `${C.phoneContainer} ${t || ""}`, children: /* @__PURE__ */ n("div", { className: C.phone, children: /* @__PURE__ */ n("div", { className: C.screenContent, children: /* @__PURE__ */ g("div", { className: C.homeScreen, children: [
    /* @__PURE__ */ g("div", { className: C.dateDisplay, children: [
      /* @__PURE__ */ g("div", { className: C.dateDisplayHeader, children: [
        /* @__PURE__ */ n("span", { className: C.iconWifi }),
        /* @__PURE__ */ g("div", { children: [
          s,
          /* @__PURE__ */ n("span", { className: C.blink, children: ":" }),
          l,
          e
        ] }),
        /* @__PURE__ */ n("span", { className: C.iconLocation })
      ] }),
      /* @__PURE__ */ n("div", { className: C.dayText, children: "Welcome!" })
    ] }),
    /* @__PURE__ */ n("div", { className: C.appsGrid, children: _n.map((c) => /* @__PURE__ */ g(
      "div",
      {
        className: `${C.appItem} ${c.offset ? C.appItemOffset : ""}`,
        style: { backgroundColor: c.color },
        children: [
          c.hasNewMessage && /* @__PURE__ */ n("span", { className: C.badge }),
          /* @__PURE__ */ n(
            "span",
            {
              className: `${C.appIcon} ${C[c.iconClass]} ${c.offset ? C.appIconOffset : ""}`
            }
          )
        ]
      },
    ...
    /* @__PURE__ */ n("div", { className: C.pageIndicator, children: /* @__PURE__ */ n("span", { className: C.iconPage }) })
  ] }) }) }) });
}, yn = "animal-divider-ZBhpE", vn = "animal-line-teal-Z80hb", bn = "animal-line-white-VDY1E", wn = "animal-line-yellow-ifvJz", xn = "animal-wave-yellow-AO-io", K = {
  divider: yn,
  ...
  waveYellow: xn
}, Cn = ({ type: t = "line-brown", className: r, style: a }) => {
  const i = [K.divider, K[t], r].filter(Boolean).join(" ");
  return /* @__PURE__ */ n("div", { className: i, style: a });
};
Cn.displayName = "Divider";
const V = (t) => t == null || typeof t == "boolean" ? 0 : typeof t == "string" || typeof t == "number" ? String(t).length : Array.isArray(t) ? t.reduce((r, a) => r + V(a), 0) : B.isValidElement(t) ? V(t.props.children) : 0, X = (t, r, a = "btw") => {
  if (r.stopped || t == null || typeof t == "boolean") return null;
  if (typeof t == "string" || typeof t == "number") {
    const i = String(t);
    if (r.remaining >= i.length)
  ...
  if (Array.isArray(t))
    return t.map((i, o) => /* @__PURE__ */ n(B.Fragment, { children: X(i, r, `${a}-${o}`) }, `${a}-${o}`));
  if (B.isValidElement(t)) {
    const i = t.props, o = X(i.children, r, a);
    return B.cloneElement(t, void 0, o);
  }
  return null;
}, Tn = ({
  ...
  const s = nt(() => V(t), [t]), l = e === "forward", [c, v] = P(
    () => i && l ? 0 : s
  ), h = $(null);
  return L(() => {
    if (h.current && window.clearInterval(h.current), !i) {
      v(s);
      return;
    }
    if (v(l ? 0 : s), s !== 0)
      return h.current = window.setInterval(() => {
        v((y) => l ? y >= s ? (h.current && window.clearInterval(h.current), y) : y + 1 : y <= 0 ? (h.current && window.clearInterval(h.current), 0) : y - 1);
      }, r), () => {
        h.current && window.clearInterval(h.current);
      };
  }, [s, r, a, i, l]), L(() => {
    l && s > 0 && c >= s && o?.(), !l && s > 0 && c <= 0 && o?.();
  }, [c, s]), /* @__PURE__ */ n(Z, { children: X(t, { remaining: c, stopped: !1 }) });
};
Tn.displayName = "BidirectionalTypewriter";
const kn = "animal-icon-wUFR-", Pn = "animal-iconBounce-Q1e3X", Mn = "animal-icon-miles-oVFnM", Ln = "animal-icon-camera-W9x4U", Sn = "animal-icon-chat-dfYOk", Rn = "animal-icon-critterpedia-vDPSY", On = "animal-icon-design-8gBms", Dn = "animal-icon-diy-AwPHs", An = "animal-icon-helicopter-w6ZL6", Nn = "animal-icon-map-ogQk4", Bn = "animal-icon-shopping-TSh2U", zn = "animal-icon-variant-E6wqy", In = "animal-iconList-MRyTC", En = "animal-iconListItem-nTF3l", Fn = "animal-iconListLabel-t2M3-", q = {
  icon: kn,
  ...
  "span",
  {
    className: `${q.icon} ${q[t]} ${o ? q["icon-bounce"] : ""} ${a || ""}`,
    style: {
      width: r,
      height: r,
      ...i
...
], $n = "animal-wrapper-pbOTq", Gn = "animal-trigger-2-Ahh", jn = "animal-open-867xo", qn = "animal-value-623RB", Hn = "animal-placeholder-vpC8E", Yn = "animal-arrow-xNbxA", Wn = "animal-dropdown-0l6jF", Un = "animal-option-GEkLI", Vn = "animal-active-jtSpt", Xn = "animal-hovered-N-cco", Zn = "animal-pillBar-O9cTb", Qn = "animal-optionDot-FQtyw", Jn = "animal-disabled-Oy12C", M = {
  wrapper: $n,
  trigger: Gn,
  open: jn,
  value: qn,
  ...
  const [e, s] = P(!1), [l, c] = P(null), [v, h] = P({}), [b, m] = P(!1), y = $(null), d = t.find((p) => p.key === r)?.label || i;
  L(() => {
    const p = (u) => {
      y.current && !y.current.contains(u.target) && (s(!1), m(!1));
    };
    return e && document.addEventListener("mousedown", p), () => document.removeEventListener("mousedown", p);
  }, [e]), L(() => {
    if (e && y.current) {
      const p = y.current.getBoundingClientRect(), u = window.innerWidth, w = window.innerHeight, T = t.length * 44 + 24, f = {
        position: "absolute"
      };
      p.right + 200 > u ? (f.right = "100%", f.marginRight = "6px", f.left = "auto") : (f.left = "100%", f.marginLeft = "6px", f.right = "auto");
      const I = w - p.bottom, at = p.top;
      I < T && at > I ? (f.top = "auto", f.bottom = "100%", f.marginBottom = "6px", delete f.transform) : I < T || p.top < T ? (f.top = "100%", f.marginTop = "6px", f.bottom = "auto", delete f.transform) : (f.top = "50%", f.transform = "translateY(-50%)", f.bottom = "auto"), h(f), requestAnimationFrame(() => {
        m(!0);
      });
    } else e || m(!1);
  }, [e, t.length]);
  ...
  return /* @__PURE__ */ g(
    ...
    {
      ref: y,
      className: `${M.wrapper} ${o ? M.disabled : ""}`,
      children: [
        /* @__PURE__ */ g(
          "div",
          {
            className: `${M.trigger} ${e ? M.open : ""}`,
            onClick: () => !o && s(!e),
            children: [
              /* @__PURE__ */ n("span", { className: r ? M.value : M.placeholder, children: d }),
              /* @__PURE__ */ n("span", { className: M.arrow, children: /* @__PURE__ */ n("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", children: /* @__PURE__ */ n("path", { d: "M3 4.5L6 7.5L9 4.5", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }) }) })
            ]
          }
        ),
        e && b && /* @__PURE__ */ n("div", { className: M.dropdown, style: v, children: t.map((p) => /* @__PURE__ */ g(
          "div",
          {
            className: `${M.option} ${r === p.key ? M.active : ""} ${l === p.key ? M.hovered : ""}`,
            onClick: () => _(p.key),
            onMouseEnter: () => c(p.key),
            onMouseLeave: () => c(null),
            children: [
              /* @__PURE__ */ n("span", { className: M.optionDot }),
              p.label,
              r === p.key && /* @__PURE__ */ n("div", { className: M.pillBar })
            ]
          },
          p.key
        )) })
...
const tr = "animal-tabs-I3QAo", er = "animal-tabList--fYUP", nr = "animal-tabItem-Ehph4", rr = "animal-active-AoX4Y", ar = "animal-tabIcon-Aiu-T", ir = "animal-tabLabel-bCauA", sr = "animal-tabLeaf-1ud9k", or = "animal-tabLeafStatic-52CX9", lr = "animal-tabContent-zDlRq", cr = "animal-tabContentInner-Y5kRC", S = {
  tabs: tr,
  tabList: er,
  tabItem: nr,
  active: rr,
  ...
  const [c, v] = P(
    ...
    a === void 0 && v(d), i?.(d);
  }, m = t.find((d) => d.key === h), y = [S.tabs, o].filter(Boolean).join(" ");
  return /* @__PURE__ */ g("div", { className: y, style: e, children: [
    /* @__PURE__ */ n("div", { className: S.tabList, children: t.map((d) => {
      const _ = d.key === h;
      return /* @__PURE__ */ g(
        "button",
        {
          className: `${S.tabItem} ${_ ? S.active : ""} ${_ && l ? S["active-shadow"] : ""}`,
          onClick: () => b(d.key),
          children: [
            /* @__PURE__ */ n("span", { className: S.tabIcon, children: _ ? "●" : "○" }),
            /* @__PURE__ */ n("span", { className: S.tabLabel, children: d.label }),
            _ && /* @__PURE__ */ n("img", { src: st, alt: "", className: `${S.tabLeaf} ${s ? "" : S.tabLeafStatic}` })
          ]
        },
        d.key
      );
    }) }),
    /* @__PURE__ */ n("div", { className: S.tabContent, children: /* @__PURE__ */ n("div", { className: S.tabContentInner, children: m?.children }) })
  ] });
};
ur.displayName = "Tabs";
const hr = "animal-checkboxGroup-q3P6l", dr = "animal-horizontal-fBBSw", pr = "animal-vertical-klL45", fr = "animal-checkboxItem-DxKFM", mr = "animal-small-2wCHI", gr = "animal-box-bIDkg", _r = "animal-checkmark-Ub21Y", yr = "animal-label-L0ila", vr = "animal-middle-VUB-E", br = "animal-large-QQxPe", wr = "animal-checked-S7gPe", xr = "animal-animal-checkbox-pop-0cWeC", Cr = "animal-disabled-zDC-1", Tr = "animal-groupDisabled-LvBFd", R = {
  checkboxGroup: hr,
  horizontal: dr,
  vertical: pr,
  checkboxItem: fr,
...
const et = /* @__PURE__ */ kr(Mr), Lr = ({
  ...
  const [v, h] = P(r), b = t !== void 0, m = b ? t : v, y = F(
    (d, _) => {
      if (o || _) return;
      const p = m.includes(d) ? m.filter((u) => u !== d) : [...m, d];
      b || h(p), s?.(p);
    },
    [o, m, b, s]
  );
  return /* @__PURE__ */ n(
    "div",
    {
      ...
      style: c,
      children: a.map((d) => {
        const _ = m.includes(d.value), p = o || d.disabled;
        return /* @__PURE__ */ g(
          "label",
          {
            className: et(
            ...
            children: [
              /* @__PURE__ */ n(
                "span",
                {
                  ...
                  tabIndex: p ? -1 : 0,
                  onKeyDown: (u) => {
                    (u.key === " " || u.key === "Enter") && (u.preventDefault(), y(d.value, d.disabled));
                  },
                  children: _ && /* @__PURE__ */ n("span", { className: R.checkmark, children: /* @__PURE__ */ n("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ n("path", { d: "M2 8L6 12L14 4", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round" }) }) })
                }
              ),
              /* @__PURE__ */ n("span", { className: R.label, children: d.label })
            ]
          },
          String(d.value)
        );
...
const x = {
  ...
  a(/\/\*[\s\S]*?\*\//g, x.comment), a(/\/\/.*$/gm, x.comment), a(/`[^`]*`/g, x.string), a(/"[^"]*"/g, x.string), a(/'[^']*'/g, x.string), a(/<\/?[A-Z][\w.$]*/g, x.jsx), a(/<\/?[a-z][\w-]*/g, x.jsx), a(/\/?>/g, x.jsx), a(/\b(React|useState|useEffect|useCallback|useMemo|useRef|useContext|useReducer|useLayoutEffect|useImperativeHandle|useDebugValue|createContext|createElement|cloneElement|Fragment|Suspense|lazy|memo|forwardRef|useId|FC|ReactNode|ReactElement|CSSProperties)\b/g, x.react), a(/\b(true|false)\b/g, x.keyword), a(/\b(null|undefined|void|NaN|Infinity)\b/gi, x.keyword), a(/\b\d+\.?\d*\b/g, x.number), a(/\b(import|from|as|export|default|const|let|var|function|return|if|else|for|while|switch|case|break|continue|try|catch|throw|finally|new|typeof|instanceof|async|await|type|interface)\b/gi, x.keyword), a(/\b[A-Z][a-zA-Z0-9_$]*\b/g, x.component), a(/\b[a-z][a-zA-Z0-9_$]*\s*(?=\()/g, x.func), a(/\b[a-zA-Z_$][\w$]*\s*(?==)/g, x.prop), a(/>|===|!==|==|!=|<=|>=|&&|\|\||[+\-*/%=<>!&|^~?:]/g, x.operator), a(/[{}[\]();,]/g, x.operator), r.sort((e, s) => e.start - s.start);
  const i = [];
  let o = 0;
  for (const e of r)
    e.start < o || (e.start > o && i.push(/* @__PURE__ */ n("span", { style: { color: x.default }, children: t.slice(o, e.start) }, `t${o}`)), i.push(/* @__PURE__ */ n("span", { style: { color: e.color }, children: t.slice(e.start, e.end) }, `s${e.start}`)), o = e.end);
  return o < t.length && i.push(/* @__PURE__ */ n("span", { style: { color: x.default }, children: t.slice(o) }, `e${o}`)), i;
}, ca = ({ code: t, style: r, className: a }) => /* @__PURE__ */ n("pre", { style: { ...Sr, ...r }, className: a, children: Rr(t) }), Or = "animal-wrapper-HLEzB", Dr = "animal-container-oauvb", Ar = "animal-closing-iG6pq", j = {
  wrapper: Or,
  container: Dr,
  closing: Ar
}, Nr = `/*!
...
</g></svg>`, Er = ({ className: t, style: r, active: a = !0 }) => {
  const i = $(null), o = $(null);
  return L(() => {
    if (!i.current) return;
    const e = document.createElement("script");
    e.textContent = Nr, i.current.appendChild(e);
    const s = document.createElement("script");
    s.textContent = Br, i.current.appendChild(s);
    const l = document.createElement("script");
    return l.textContent = zr, i.current.appendChild(l), () => {
      e.remove(), s.remove(), l.remove();
    };
  }, []), L(() => {
    if (!o.current || !i.current) return;
    const e = i.current, s = e.getBoundingClientRect(), l = Math.ceil(Math.hypot(s.width, s.height) / 2) + 50, c = Math.max(0.1, l / 1500);
    a ? (e.classList.remove(j.closing), e.style.transition = "", e.style.setProperty("--mask-r", "0px"), e.style.display = "flex") : (e.classList.add(j.closing), e.style.transition = "", e.style.setProperty("--mask-r", "0px"), e.offsetHeight, e.style.transition = `--mask-r ${c}s linear`, e.style.setProperty("--mask-r", `${l}px`), setTimeout(() => {
      i.current && (i.current.style.display = "none");
    }, c * 1e3));
  }, [a]), /* @__PURE__ */ n("div", { ref: o, className: j.wrapper, children: /* @__PURE__ */ n("div", { ref: i, className: `${j.container} ${t || ""}`, style: r, children: /* @__PURE__ */ n("div", { dangerouslySetInnerHTML: { __html: Ir } }) }) });
};
Er.displayName = "Loading";
const Fr = "animal-wrapper-LJBly", $r = "animal-scrollable-5Wnhh", Gr = "animal-table-Os4fM", jr = "animal-thead-2ge5M", qr = "animal-headerRow-sAsWX", Hr = "animal-headerCell-LhL6h", Yr = "animal-tbody-3RGsp", Wr = "animal-row-iDOMw", Ur = "animal-cell-4PAU2", Vr = "animal-striped-8Ih-N", Xr = "animal-emptyCell--stiv", Zr = "animal-emptyContent-JrC1j", Qr = "animal-emptyIcon-SNcRm", Jr = "animal-loading-mPt0l", Kr = "animal-loadingOverlay-PMW6Z", ta = "animal-loadingSpinner-KZEsv", k = {
  wrapper: Fr,
  scrollable: $r,
  table: Gr,
  thead: jr,
  ...
  const m = (u, w) => typeof a == "function" ? a(u) : u[a] || String(w), y = (u, w) => {
    const T = [k.row];
    return i && w % 2 === 1 && T.push(k.striped), e && (typeof e == "function" ? T.push(e(u, w)) : T.push(e)), T.join(" ");
  }, d = (u, w, T) => {
    const f = u.dataIndex ? w[u.dataIndex] : void 0;
    return u.render ? u.render(f, w, T) : f;
  }, _ = [
    k.table,
    l && k.loading,
    h
  ...
  return /* @__PURE__ */ g("div", { className: p, style: b, children: [
    /* @__PURE__ */ g("table", { className: _, children: [
      o && /* @__PURE__ */ n("thead", { className: k.thead, children: /* @__PURE__ */ n("tr", { className: k.headerRow, children: t.map((u, w) => /* @__PURE__ */ n(
        "th",
        {
      ...
      /* @__PURE__ */ n("tbody", { className: k.tbody, children: r.length === 0 ? /* @__PURE__ */ n("tr", { children: /* @__PURE__ */ n(
        "td",
        {
          colSpan: t.length,
          className: k.emptyCell,
          children: /* @__PURE__ */ g("div", { className: k.emptyContent, children: [
            /* @__PURE__ */ n(
              "svg",
              {
      ...
      ) }) : r.map((u, w) => /* @__PURE__ */ n(
        "tr",
        {
          className: y(u, w),
          ...s?.(u, w),
          children: t.map((T, f) => /* @__PURE__ */ n(
            "td",
            {
              className: k.cell,
              style: {
    ...
    l && /* @__PURE__ */ n("div", { className: k.loadingOverlay, children: /* @__PURE__ */ n("div", { className: k.loadingSpinner, children: /* @__PURE__ */ n("svg", { viewBox: "0 0 50 50", width: "40", height: "40", children: /* @__PURE__ */ n(
      "circle",
      {
        cx: "25",
        cy: "25",
